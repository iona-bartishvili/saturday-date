# Saturday Date copy deck

Edit the wording below when you want to revise the invitation. Keep the headings and
labels intact so each phrase remains easy to locate in `index.html`.

## Browser title and metadata

- **Page title:** Saturday Date — Tbilisi
- **Description:** A Saturday of thrifting, eating, and wandering around Tbilisi.
...
- **Comment placeholder:** Write a little note...
- **Submit button:** Confirm our date
- **Sending status:** Sending your answer…
- **Error status:** Your answer could not be sent. Please try again.

## Matcha response

- **Eyebrow:** OH NO
- **Headline:** Matcha?!
- **Message:** The date has been very dramatically cancelled. Just kidding — choose another coffee and we can save Saturday.
- **Button:** Crisis averted

## Decline response

- **Eyebrow:** A SMALL RAIN CHECK
- **Headline:** I’ll save the route.
- **Message:** No worries at all. The city, the coffee, and the invitation will be here when the timing is right.
- **Button:** Close

## Acceptance response

- **Eyebrow:** SEE YOU SATURDAY
- **Headline:** It’s a date.
- **Message:** Your answer is on its way. I’m already looking forward to it.
- **Button:** Close
